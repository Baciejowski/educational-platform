...
namespace Backend.Controllers.APIs
{
    [ApiController]
    [Route("api/scenarios")]
    public class ScenarioApiController2 : Controller
    {
        private readonly DataContext _dataContext;
        private readonly ILogger<ScenarioApiController2> _logger;

        public ScenarioApiController2(DataContext dataContext, ILogger<ScenarioApiController2> logger)
        {
