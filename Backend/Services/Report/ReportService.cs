        ...
        public class ReportService : IReportService
        {
            ...
            public string SuccessPerScenarioGraph()
            {
                ...
                foreach (var group in groupedSessions)
                {
                    ...
                    result.Add(new { name = ReduceScenarioName(group.Key), noAdaptivity = avg[0], basic = avg[1], advanced = avg[2] });
                }
            ...
            public string AvgTimePerScenarioGraph()
            {
                ...
                foreach (var group in groupedSessions)
                {
                    ...
                    result.Add(new
                        { name = ReduceScenarioName(group.Key), total = total, noAdaptivity = avg[0], basic = avg[1], advanced = avg[2] });
                }
