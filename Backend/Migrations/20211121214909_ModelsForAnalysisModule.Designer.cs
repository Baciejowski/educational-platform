...
namespace Backend.Migrations
{
    ...
    [Migration("20211121214909_ModelsForAnalysisModule")]
    partial class ModelsForAnalysisModule
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AnswerAnsweredQuestion", b =>
                {
                    b.Property<int>("AnsweredAnswersAnswerID")
                        .HasColumnType("integer");

                    b.Property<int>("AnsweredQuestionsAnsweredQuestionID")
                        .HasColumnType("integer");

                    b.HasKey("AnsweredAnswersAnswerID", "AnsweredQuestionsAnsweredQuestionID");

                    b.HasIndex("AnsweredQuestionsAnsweredQuestionID");

                    b.ToTable("AnswerAnsweredQuestion");
                });
            ...
            modelBuilder.Entity("AnswerAnsweredQuestion", b =>
                {
                    b.HasOne("Backend.Models.Answer", null)
                        .WithMany()
                        .HasForeignKey("AnsweredAnswersAnswerID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Backend.Models.AnsweredQuestion", null)
                        .WithMany()
                        .HasForeignKey("AnsweredQuestionsAnsweredQuestionID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
